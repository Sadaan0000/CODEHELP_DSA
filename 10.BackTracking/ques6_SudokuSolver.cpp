...
//this function returns true or false on the basis of we found a solution or not 
    ...
    for(int i=0;i<n;i++ ){
        for( int j=0;j<n;j++ ){
            ...
            if( board[i][j] == 0 ){
                ...
                //if no value fits in this cell then backtrack
                return false;
            }
        }
    }
